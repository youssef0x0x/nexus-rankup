...
import { Check, Plus, RotateCcw, Target, Trash2, UserRound, X } from 'lucide-react';
...
export const ProfileSwitcher: React.FC<ProfileSwitcherProps> = ({ onClose }) => {
  const { profiles, activeProfile, switchProfile, createProfile, resetProgress, deleteProfile, setProfileGoals } = useGameState();
  ...
  const submit = (event: React.FormEvent) => {
    ...
    createProfile(form.username, form.avatar, form.title);
    onClose();
  };
